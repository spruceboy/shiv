...
class ESRIRestTileHandler < RackWelder
  ...
  def process(request, response)
    ...
    when nil then
      give_X(response, 200, 'text/plain',
             "A more complete  page is forth comming, but meanwhile this service provides \"" + @cfg['esri_rest']['description'] + "\"")
      return
    end
  ...
  def get_poo
    hsh_template = { 'spatialReference' => { 'wkid' => 666 },
                     'mapName' => 'not known',
                     'serviceDescription' =>      'Not known.',
                     'singleFusedMapCache' => true,
                     'layers' =>   [{ 'subLayerIds' => nil,
                                      'name' => 'Not known.',
                                      'parentLayerId' => -1,
                                      'id' => 0,
                                      'defaultVisibility' => true }],
                     'copyrightText' => '(c) someone',
                     'fullExtent' =>   { 'spatialReference' => { 'wkid' => 10 },
                                         'ymax' => 0.0,
                                         'xmax' => 0.0,
                                         'ymin' => -10.0,
                                         'xmin' => -3.0 },
                     ...
                     'initialExtent' =>   { 'spatialReference' => { 'wkid' => 10_101 },
                                            'ymax' => 0.0,
                                            'xmax' => 0.0,
                                            'ymin' => -10.0,
                                            'xmin' => -30.0 },
                     'documentInfo' =>   { 'Category' => 'shiv',
                                           'Subject' => 'shiv',
                                           'Keywords' => 'shiv',
                                           'Author' => 'shiv',
                                           'Title' => '',
    ...
    hsh_template['serviceDescription'] =	hsh_template['spatialReference'] = { 'wkid' => (@cfg['esri_rest']['projection']).to_i }
